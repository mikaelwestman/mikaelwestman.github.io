class Projects extends HTMLElement {
  ...
  isDigitalProject(bodyId) {
    const digitalProjects = ['rolo-radio', 'square-for-restaurants', 'square-pos', 'epidemic-sound', '3d', 'variable-font', 'vexillography'];
  ...
  getDigitalProjects(excludeId = null) {
    const digitalProjects = [
      { id: 'rolo-radio', href: 'rolo-radio.html', image: 'images/rolo-radio_mikael-westman_thumbnail.jpg', title: 'Rolo Radio' },
